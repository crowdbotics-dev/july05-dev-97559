...
export const api_v1_mithilrs_list = createAsyncThunk(
  "mithilrs/api_v1_mithilrs_list",
  async payload => {
    const response = await apiService.api_v1_mithilrs_list(payload)
    return response.data
  }
)
export const api_v1_mithilrs_create = createAsyncThunk(
  "mithilrs/api_v1_mithilrs_create",
  async payload => {
    const response = await apiService.api_v1_mithilrs_create(payload)
    return response.data
  }
)
export const api_v1_mithilrs_retrieve = createAsyncThunk(
  "mithilrs/api_v1_mithilrs_retrieve",
  async payload => {
    const response = await apiService.api_v1_mithilrs_retrieve(payload)
    return response.data
  }
)
export const api_v1_mithilrs_update = createAsyncThunk(
  "mithilrs/api_v1_mithilrs_update",
  async payload => {
    const response = await apiService.api_v1_mithilrs_update(payload)
    return response.data
  }
)
export const api_v1_mithilrs_partial_update = createAsyncThunk(
  "mithilrs/api_v1_mithilrs_partial_update",
  async payload => {
    const response = await apiService.api_v1_mithilrs_partial_update(payload)
    return response.data
  }
)
export const api_v1_mithilrs_destroy = createAsyncThunk(
  "mithilrs/api_v1_mithilrs_destroy",
  async payload => {
